...
from apps.carreras.views import mostrarCE, registrarCarrera, registrarEspecialidad, carreraUpdate, especialidadUpdate, carreraDelete, especialidadDelete

urlpatterns = [
    url(r'^$', mostrarCE, name='carrera'),
